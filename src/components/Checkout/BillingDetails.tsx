...
const BillingDetails = () => {
 ...
 const { formData, setFormData, phone, setPhone, errors, setErrors } = useCheckout();
 ...
 return (
   <div>
     <div className="space-y-6 text-sm md:space-y-8">
       ...
       <div className="flex flex-col gap-4 md:flex-row lg:items-start">
        <div className="shrink grow basis-0 space-y-1">
          ...
          <input
            ...
            className={inputClassName(!!errors.firstName && !!touched.firstName)}
          />
        ...
        <div className="shrink grow basis-0 space-y-1">
          ...
          <input
            ...
            className={inputClassName(!!errors.lastName && !!touched.lastName)}
          />
      ...
      <div className="flex flex-col gap-4 md:flex-row lg:items-start">
        <div className="shrink grow basis-0 space-y-1">
          ...
          <select
            ...
            className={inputClassName(!!errors.country && !!touched.country)}
        ...
        <div className="shrink grow basis-0 space-y-1">
          ...
          <select
            ...
            className={inputClassName(!!errors.state && !!touched.state)}
      ...
      <div className="flex flex-col gap-4 md:flex-row lg:items-start">
        ...
        <div className="shrink grow basis-0 space-y-1">
          ...
          <input
            ...
            className={inputClassName(!!errors.address && !!touched.address)}
          />
      ...
      {/* Assistance Section */}
      <div className="mt-6 w-full rounded-xl bg-white p-6 hidden sm:block">
